    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-base font-medium text-muted-foreground mb-1">No native sessions</p>
          <p className="text-sm text-muted-foreground">Quick tasks will appear here</p>
        </div>
      </div>
    );
  }
