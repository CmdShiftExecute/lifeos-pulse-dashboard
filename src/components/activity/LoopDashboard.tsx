    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-base font-medium text-muted-foreground mb-1">No loop sessions</p>
          <p className="text-sm text-muted-foreground">Iterative loop runs will appear here</p>
        </div>
      </div>
    );
  }
