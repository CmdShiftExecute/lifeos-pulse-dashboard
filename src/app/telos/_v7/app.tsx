    ...
    <>
      {view === "columns" ? (
        isFreshInstall ? (
          ...
          <CommandCenter telos={telos} showIds={showIds} />
        )
      ) : (
        <main className="frame" data-tone={tweaks.vals.narrativeTone} data-view={view}>
          ...
          <footer className="ftr">
            ...
            <span>
              {telos.goals.length} goals · {telos.strategies.length} strategies
            </span>
          </footer>
        </main>
      )}
